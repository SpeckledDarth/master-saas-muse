...
import {
  ...
  Award, MousePointerClick, ArrowRight, FileImage, FileText,
  ExternalLink, Clock, CheckCircle, Sparkles, Rocket,
} from 'lucide-react'
...
export default function AffiliateDashboardPage() {
  ...
  const handleActivate = async () => {
    ...
    try {
      ...
      toast({ title: 'Affiliate Program Activated!', description: 'Your terms have been locked in. Start sharing your link to earn commissions!' })
      fetchData()
    } catch {
      toast({ title: 'Error', description: 'Could not activate affiliate program', variant: 'destructive' })
    } finally {
      setActivating(false)
    }
  }
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]" data-testid="loading-affiliate-dashboard">
      ...
      <div className="max-w-2xl mx-auto py-12 px-4" data-testid="affiliate-activate-prompt">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Earn Money by Sharing</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center">
              <Button size="lg" onClick={handleActivate} disabled={activating} data-testid="button-activate-affiliate">
                {activating ? <Loader2 className="h-4 w-4 animate-spin mr-2" /> : <Sparkles className="h-4 w-4 mr-2" />}
    ...
    <div className="space-y-6 max-w-5xl" data-testid="page-affiliate-dashboard">
      ...
      <Tabs defaultValue="referrals" data-testid="tabs-affiliate-dashboard">
        <TabsList>
          ...
          <TabsTrigger value="assets" data-testid="tab-assets">Marketing Assets ({assets.length})</TabsTrigger>
        </TabsList>
