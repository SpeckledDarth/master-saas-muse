...
export default function AcceptableUsePage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <Loader2 className="h-8 w-8 animate-spin" data-testid="loader-acceptable-use" />
      </div>
    )
  }
  ...
  if (!compliance?.acceptableUseEnabled) {
    return (
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground" data-testid="text-acceptable-use-updated">
            Last updated: {legal?.acceptableUseLastUpdated || 'Not specified'}
          </p>
        </div>
