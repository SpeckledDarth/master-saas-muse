...
export default function SecurityPolicyPage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <Loader2 className="h-8 w-8 animate-spin" data-testid="loader-security-policy" />
      </div>
    )
  }
  ...
  if (!compliance?.securityPolicyEnabled) {
    return (
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground" data-testid="text-security-policy-updated">
            Last updated: {legal?.securityPolicyLastUpdated || 'Not specified'}
          </p>
        </div>
        <div className="prose prose-neutral dark:prose-invert max-w-none" data-testid="content-security-policy">
          <ReactMarkdown>
            {stripFirstHeading(legal?.securityPolicy
