...
export function SocialProofPopup({
  ...
  return (
    ...
    >
      <div className="bg-[var(--card-bg)] rounded-[var(--card-radius,0.75rem)] shadow-[var(--card-shadow)] border p-[var(--card-padding,1.25rem)] flex items-start gap-[var(--content-density-gap,1rem)]">
