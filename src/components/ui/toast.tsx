...
const toastPositionClasses: Record<string, string> = {
  'top-right': 'fixed top-0 right-0 z-[100] flex max-h-screen w-full flex-col p-4 md:max-w-[420px]',
  'top-center': 'fixed top-0 left-1/2 -translate-x-1/2 z-[100] flex max-h-screen w-full flex-col p-4 md:max-w-[420px]',
  'bottom-right': 'fixed bottom-0 right-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 md:max-w-[420px]',
  'bottom-center': 'fixed bottom-0 left-1/2 -translate-x-1/2 z-[100] flex max-h-screen w-full flex-col-reverse p-4 md:max-w-[420px]',
}
...
>(({ className, ...props }, ref) => {
  const position = typeof document !== 'undefined'
    ? document.documentElement.getAttribute('data-toast-position') || 'bottom-right'
    : 'bottom-right'
  ...
  return (
    <ToastPrimitives.Viewport
      ref={ref}
      className={cn(
        toastPositionClasses[position] || toastPositionClasses['bottom-right'],
        className
      )}
      {...props}
    />
