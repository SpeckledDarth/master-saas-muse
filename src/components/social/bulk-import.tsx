        ...
        <div className="space-y-[var(--content-density-gap,1rem)] flex-1 overflow-hidden flex flex-col">
          <div className="flex items-center gap-[var(--content-density-gap,1rem)] flex-wrap">
            <input
              ...
              className="text-sm file:mr-3 file:rounded-[var(--btn-radius,9999px)] file:border-0 file:bg-primary-600 dark:file:bg-primary-400 file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-white dark:file:text-black"
