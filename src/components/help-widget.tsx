  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div className="flex items-center justify-between gap-2 border-b p-[var(--card-padding,1.25rem)]">
          ...
          <div className="flex-1 overflow-y-auto p-[var(--card-padding,1.25rem)] space-y-3">
            {messages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div
                  className={`max-w-[80%] rounded-[var(--card-radius,0.75rem)] px-3 py-2 text-sm ${
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="bg-muted rounded-[var(--card-radius,0.75rem)] px-3 py-2 text-sm" data-testid="text-loading">Thinking...</div>
              </div>
            )}
          ...
          {fallbackEmail && (
            <div className="px-[var(--card-padding,1.25rem)] pb-1">
          ...
          {hasUserMessages && !npsSubmitted && (
            <div className="border-t px-[var(--card-padding,1.25rem)] py-3 space-y-2">
          ...
          {npsSubmitted && (
            <div className="border-t px-[var(--card-padding,1.25rem)] py-2">
