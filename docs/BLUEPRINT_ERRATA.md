...
> **Total issues:** 9 (2 already fixed, 7 remaining)
...
### ⬜ Issue #1 — Wrong migration file number
...
### ⬜ Issue #2 — S8-T1 missing context about existing user_profiles columns
...
### ⬜ Issue #3 — S8-T4 vague file reference for migration
...
### ⬜ Issue #4 — S9-T4 missing Supabase Storage bucket prerequisite
...
### ⬜ Issue #5 — S8-T2 missing MuseKit/PassivePost boundary confirmation
...
### ⬜ Issue #8 — Sprint 7 Done Test grep pattern too loose
...
### ⬜ Issue #9 — Sprint 8 Done Test missing grandfathering non-regression check
...
|-------|--------|------|--------|
| #1 — Wrong migration number (018 → 017) | 8 | S8-T1 | ⬜ NOT FIXED |
| #2 — Missing user_profiles existing columns context | 8 | S8-T1 | ⬜ NOT FIXED |
| #3 — Vague migration file reference | 8 | S8-T4 | ⬜ NOT FIXED |
| #4 — Missing Supabase Storage bucket prerequisite | 9 | S9-T4 | ⬜ NOT FIXED |
| #5 — Missing MuseKit boundary confirmation | 8 | S8-T2 | ⬜ NOT FIXED |
| #6 — Missing Design Decision #9 reference | 7 | S7-T5 | ✅ FIXED |
| #7 — Component spec too vague | 7 | S7-T3 | ✅ FIXED |
| #8 — Done Test grep pattern too loose | 7 | Done Test | ⬜ NOT FIXED |
| #9 — Done Test missing grandfathering check | 8 | Done Test | ⬜ NOT FIXED |
