...
| **Typography Color Pickers** | Custom heading color and body text color pickers on the palette page with clear/reset capability. Injected as `--heading-color` and `--body-color` CSS variables. | Admins can set exact text colors independent of the theme's foreground color. |
